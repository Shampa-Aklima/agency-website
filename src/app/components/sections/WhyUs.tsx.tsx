...
const WhyUsFeatures = [
  {
    icon: <Play className="h-6 w-6 text-accent-green" />,
    title: "Interactive Experience",
    description:
      "Engage with our AI agents through natural language conversations and interactive interfaces.",
  },
  {
  ...
  return (
    <section className=" py-12 sm:py-16 md:py-20 relative overflow-hidden">
      <div className="max-w-6xl container mx-auto px-4 sm:px-6">
        ...
        >
          <h2 className="text-5xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 text-white">
            Global talent.Local expertise.
          </h2>
          <p className="text-white/70 text-sm sm:text-base max-w-2xl mx-auto">
           Our development teams work closely with you to build everything from web solutions to AI systems.
          </p>
        </motion.div>
